...
<?php $__env->startSection('content'); ?>
  ...
  <form class="form" method="POST" action="<?php echo e($url->to('forum')->route('savePassword')); ?>">
    ...
    <p class="form-group">
      <input type="password" class="form-control" name="password" placeholder="<?php echo e($translator->trans('core.views.reset_password.new_password_label')); ?>">
    </p>

    <p class="form-group">
      <input type="password" class="form-control" name="password_confirmation" placeholder="<?php echo e($translator->trans('core.views.reset_password.confirm_password_label')); ?>">
    </p>
